...
public abstract class Parcel : IComparable<Parcel> // We are implmenting IComparable interface to be able to compare instances
{
    protected double gogo;
    ...
    public int CompareTo(Parcel other) // CompareTo performs a comparison of instances of the class againt instances of the class
    {
        if (other.CalcCost() > CalcCost()) // if cost less return -1, if the bigger return 1, if equal return 0
            return -1;
        else if (other.CalcCost() < CalcCost())
            return 1;
        else
            return 0;
    }
